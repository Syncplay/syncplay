...
MPV_SLAVE_ARGS_WINDOWS = ['--slave-broken', '-af', 'scaletempo']
MPV_SLAVE_ARGS_NONWINDOWS = ['--input-terminal=no','--input-file=/dev/stdin', '-af', 'scaletempo']
MPV_SLAVE_ARGS_NEW = ['--term-playing-msg=<SyncplayUpdateFile>\nANS_filename=${filename}\nANS_length=${=length}\nANS_path=${path}\n</SyncplayUpdateFile>', '-af', 'scaletempo']
