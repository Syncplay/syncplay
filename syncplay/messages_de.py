...
de = {
    ...
    "syncplay-autoremovefromplaylist-label": "Gesehene Dateien automatisch aus der Playlist entfernen",
    ...
    "autoremovewatchedfromplaylist-tooltip": "Entfernt einen Playlist-Eintrag aus der geteilten Playlist, wenn Syncplay ihn nach Erreichen des Wiedergabeendes als gesehen markiert.",
