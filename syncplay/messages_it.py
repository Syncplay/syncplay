...
it = {
    ...
    "syncplay-autoremovefromplaylist-label": "Rimuovi automaticamente i file visti dalla playlist",
    ...
    "autoremovewatchedfromplaylist-tooltip": "Rimuove un elemento dalla playlist condivisa quando Syncplay lo contrassegna come visto dopo che la riproduzione raggiunge la fine.",
