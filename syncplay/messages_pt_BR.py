...
pt_BR = {
    ...
    "syncplay-autoremovefromplaylist-label": "Remover automaticamente arquivos assistidos da playlist",
    ...
    "autoremovewatchedfromplaylist-tooltip": "Remove um item da playlist compartilhada quando o Syncplay o marca como assistido após a reprodução chegar ao fim.",
