    ...
    class __Listener():
        def __init__(self, playerController, playerPath, filePath, args, reactor):
            ...
            def _intfNeedsUpdating(vlcSyncplayInterfacePath):
                ...
                return True
            if _intfNeedsUpdating(os.path.join(self.__playerController.vlcIntfUserPath, "syncplay.lua")):
                try:
            ...
            self.__playerController.SLAVE_ARGS.append('--data-path={}'.format(self.__playerController.vlcDataPath))
