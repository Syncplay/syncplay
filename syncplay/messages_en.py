...
en = {
    ...
    "failed-to-load-server-list-error" : "Failed to load public server list. Please visit http://www.syncplay.pl/ in your browser.",
    ...
    "syncplay-mediasearchdirectories-title" : "Directories to search for media (one path per line)",
    "sync-label" : "Sync",
