...
pt_PT = {
    ...
    "syncplay-autoremovefromplaylist-label": "Remover automaticamente ficheiros vistos da lista de reprodução",
    ...
    "autoremovewatchedfromplaylist-tooltip": "Remove um item da lista de reprodução partilhada quando o Syncplay o marca como visto depois de a reprodução chegar ao fim.",
